...
<nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
    ...
    <img class="img-fluid" src="resources/images/logo-white.svg" alt="logo" style="width: 40px;">
    </a>
    ...
    <div class="dropdown" data-bs-theme="light">
    <button type="button" class="btn nav-link text-white dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
    <i class="bi-brightness-high-fill"></i><spanclass="d-lg-none">Toggle theme</span>
    </button>
    <ul class="dropdown-menu dropdown-menu-end">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid" src="resources/images/main.svg" alt="main logo">
                </div>
    ...
    <!-- Container -->
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                <img class="img-fluid" src="resources/images/bs-icons.png" alt="Bootstrap Icons">
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Container -->
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                <img class="img-fluid" src="resources/images/bs-themes.png" alt="Bootstrap Themes">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-3 mb-5">
                    ...
                    <div class="d-flex">
                        <img class="img-fluid" src="resources/images/logo-black.svg" alt="Bootstrap Logo" style="width: 40px;">
...
<?php /**PATH C:\Users\asus\OneDrive\Documents\3. Tel-U Surabaya\- Codes\Semester 4 - Bootstrap - Pemrograman Framework\Week-4\Modul-3\resources\views/clone.blade.php ENDPATH**/ ?>